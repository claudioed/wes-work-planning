...
description: ADR 0013 — the fleet-wide OTel Tier 1 baseline (telemetry.Setup, otelchi RED metrics, /healthz) and Tier 2 business-metric naming/attribute convention every service follows.
---
