/**
 * Runtime endpoint resolution for planning_mfe.
 *
...
const API_PATH = "/api/wes-work-planning";
const DEV_API_BASE = "http://localhost:8083";

export function resolveWesApiBase(
...
export const WES_API_BASE = resolveWesApiBase(
